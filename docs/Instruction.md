...
| Skrypt / Moduł                                    | Opis |
|---------------------------------------------------|------|
| `scientometrics_quotes`                           | Przetwarza dane wejściowe, łączy dane o publikacjach i czasopismach |
| `scientometrisc_search_engine`                    | Generuje zapytania (frazy) do silnika semantycznego |
| `scientometrics_queries_generator`                | Generuje embeddingi oraz przygotowuje dane dla bazy wektorowej |
| `scientometrics_distribution_experiment-*`        | Przeprowadza eksperymenty z dystrybucją cytowań |
| `scientometrics_distribution_summary`           | Agreguje wyniki i generuje wykresy końcowe |
...
**Używana wersja:**  
- `scientometrics_distribution_experiment_embedding-copy-1`
...
### 4.5 `4.5 scientometrics_distribution_experiment_merge`
